...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TABLE "pages_blocks_timeline_timeline" (
  ...
  CREATE TABLE "_pages_v_blocks_timeline_timeline" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  ...
  CREATE INDEX "pages_blocks_timeline_timeline_order_idx" ON "pages_blocks_timeline_timeline" USING btree ("_order");
  CREATE INDEX "pages_blocks_timeline_timeline_parent_id_idx" ON "pages_blocks_timeline_timeline" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_timeline_timeline_order_idx" ON "_pages_v_blocks_timeline_timeline" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_timeline_timeline_parent_id_idx" ON "_pages_v_blocks_timeline_timeline" USING btree ("_parent_id");
