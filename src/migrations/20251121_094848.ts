...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "pages_blocks_content_columns" (
  	...
  	"media_id" integer,
  	"column_class_name" varchar DEFAULT '',
  	"rich_text" jsonb,
  	"enable_link" boolean,
  ...
  CREATE TABLE "pages_blocks_content" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"class_name" varchar DEFAULT 'bg-white',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "header_nav_items_sub_nav_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE INDEX "header_nav_items_sub_nav_items_order_idx" ON "header_nav_items_sub_nav_items" USING btree ("_order");
  CREATE INDEX "header_nav_items_sub_nav_items_parent_id_idx" ON "header_nav_items_sub_nav_items" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_header_nav_items_sub_nav_items_link_type";
